...
state.units.setReal()
state.bounds = Bounds(state, lo = Vector(-200, -200, -200), hi = Vector(200, 200, 200))
state.rCut = 50.0
state.padding = 0.5
state.periodicInterval = 100
state.shoutEvery = 1000
state.dt = 20.0
state.setSpecialNeighborCoefs(1, 0, 0)
...
state.addAtom(handle='P', pos=Vector(0,0,5),q=-0.6)
...
fixNVT.setParameters(12345,0.002)
